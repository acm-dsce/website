        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card className="glass-card card-3d hover:shadow-3d transition-all duration-300 h-full">
            <CardContent className="p-8 text-center flex flex-col h-full">
              <div className="w-16 h-16 bg-gradient-primary rounded-full flex items-center justify-center mx-auto mb-4 flex-shrink-0">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <h3 className="text-xl font-bold mb-3 flex-shrink-0">Education</h3>
          ...
          <Card className="glass-card card-3d hover:shadow-3d transition-all duration-300 h-full">
            <CardContent className="p-8 text-center flex flex-col h-full">
              ...
              <h3 className="text-xl font-bold mb-3 flex-shrink-0">Networking</h3>
              <p className="text-muted-foreground flex-grow">
          ...
          <Card className="glass-card card-3d hover:shadow-3d transition-all duration-300 h-full">
            <CardContent className="p-8 text-center flex flex-col h-full">
              ...
              <h3 className="text-xl font-bold mb-3 flex-shrink-0">Innovation</h3>
              <p className="text-muted-foreground flex-grow">
